...
import { computed, defineAsyncComponent, ref, shallowRef, watch, onMounted, nextTick } from 'vue'
...
<template>
  <div class="flex min-w-[75px]  bg-[#e8eaf1] pb-2 dark:bg-[#25272d]  dark:border-[#3a3a40]    border-#efeff5-800 " :class="getMobileLayoutClass" :style="mobileSafeArea">
    ...
    <main :class="['flex-1 flex-grow-1 mb-5 overflow-auto', getIconMobileLayoutClass]" ref="track">
			<NScrollbar :size="1">
