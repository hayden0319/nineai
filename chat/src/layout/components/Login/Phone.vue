...
import { NButton, NForm, NFormItem, NInput, useMessage, FormItemRule } from 'naive-ui'
...
<template>
  ...
  <span class="flex justify-center cursor-pointer" v-if="phoneRegisterStatus">
	...
	<div class="flex items-center justify-center space-x-5 " :class="phoneRegisterStatus ? 'mt-[16px]' : 'mt-[36px]'">
		<n-button v-if="wechatRegisterStatus" ghost class="!px-10" @click="emit('changeLoginType', 'wechat')">
